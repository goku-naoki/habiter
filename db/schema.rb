...
ActiveRecord::Schema.define(version: 2020_11_12_044252) do
  ...
  create_table "habit_users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["habit_id"], name: "index_habit_users_on_habit_id"
    t.index ["user_id"], name: "index_habit_users_on_user_id"
  end
